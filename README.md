...
- [ ] Compose and Reply views are created exactly as in real Twitter app including profile pic placements
- [ ] Added a label and button to UIKeyboardToolbar as in real Twitter app instead of navigation bar
